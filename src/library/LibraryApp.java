        ...
        do {
            ...
            switch (inChar){
                ...
                case 'b': case 'B'://borrow one book
                    lib.borrowBook("Data","jordan","smith");
                    break;
                case 'r': case 'R'://return one book via the book loan Id
                    lib.returnBook(300008);
                    break;
                case 'a': case 'A'://add a new book
                    String [] authorNames = new String [] {"Jaideva, Goswami", "jora ,barba"};
                    lib.addNewBook("data mining ,handbook", authorNames,
                            2010,4);
                    break;
                case 'n': case 'N'://add a new member
                    lib.addNewMember("Jora","barba",LocalDate.now());
                    break;
                case 'c': case 'C'://change the stock for a book
                    lib.changeQuantity("Data Mining",-4);
                    break;
                case 'q': case 'Q'://quit
                    return;
                default:
